...
type Listing = {
  ...
  price: string;
  addr: string;
  meta: Array<{ value: string; unit?: string }>;
};
...
const listings: Listing[] = [
  {
    ...
    price: "$689,000",
    addr: "485 Mountain View Drive, Stansbury Park",
    meta: [
      { value: "4", unit: "bd" }, { value: "3", unit: "ba" },
      { value: "2,840", unit: "sqft" }, { value: "0.32", unit: "ac" },
    ],
  },
  {
    badge: "New Build",
    badgeStyle: { background: "rgba(201,167,118,.95)", color: "var(--navy)" },
    hasVideo: true,
    img: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80",
    price: "$429,000",
    addr: "Highland Community Lot 47, Grantsville",
    meta: [
      { value: "3", unit: "bd" }, { value: "2.5", unit: "ba" },
      { value: "2,180", unit: "sqft" }, { value: "UpDwell" },
    ],
  },
  {
    badge: "Acreage",
    ...
    price: "$1,250,000",
    addr: "1180 East Erda Way, Erda",
    meta: [
      { value: "5", unit: "bd" }, { value: "4", unit: "ba" },
      { value: "4,600", unit: "sqft" }, { value: "5.2", unit: "ac" },
    ],
  },
  {
    badge: "Price Drop",
    ...
    price: "$385,000",
    addr: "227 South Plum Street, Tooele",
    meta: [
      { value: "3", unit: "bd" }, { value: "2", unit: "ba" },
      { value: "1,680", unit: "sqft" }, { value: "0.18", unit: "ac" },
    ],
  },
  {
    badge: "Open House",
    ...
    price: "$549,900",
    addr: "812 Lakeside Boulevard, Stansbury Park",
    meta: [
      { value: "4", unit: "bd" }, { value: "2.5", unit: "ba" },
      { value: "2,340", unit: "sqft" }, { value: "0.25", unit: "ac" },
    ],
  },
  {
    badge: "Commercial",
    img: "https://images.unsplash.com/photo-1564013434775-f71db0030976?w=800&q=80",
    price: "$895,000",
    addr: "105 N Main Street, Downtown Tooele",
    meta: [
      { value: "4,200", unit: "sqft" }, { value: "Retail" }, { value: "0.4", unit: "ac" },
    ],
  },
];
          ...
          <div className="hero-grid">
            ...
            <div className="hero-visual">
              <div className="hero-card hc-1">
                <div className="hc-tag"><strong>485 Mountain View Dr</strong>Stansbury Park · $689,000</div>
              </div>
              <div className="hero-card hc-2">
                <div className="hc-tag"><strong>Highland Community</strong>New build · From $429K</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="listings">
        <div className="container">
          ...
          <div className="listing-grid">
            {listings.map((l) => (
              <div key={l.addr} className="listing-card">
                <div className="listing-img" style={{ backgroundImage: `url(${l.img})` }}>
                  <span className="listing-badge" style={l.badgeStyle}>{l.badge}</span>
                  {l.hasVideo && <span className="listing-video">▶ VIDEO TOUR</span>}
                </div>
                <div className="listing-body">
                  ...
                  <div className="listing-meta">
                    {l.meta.map((m, i) => (
                      <span key={i}><strong>{m.value}</strong>{m.unit ?? ""}</span>
                    ))}
                  </div>
                </div>
              </div>
          ...
          <div className="listings-cta">
            <button className="btn btn-ghost">View All 247 Active Listings</button>
          </div>
        </div>
      </section>
